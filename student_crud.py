...
DB_NAME = "postgres"
DB_USER = "postgres.gfwaauiwkcswvakelgli"
DB_PASSWORD = "eZvyWRKUQuT0T7vZ"
...
if __name__ == "__main__":
    ...
    insert_teacher("Mrigendra Pradhan", 30)
    insert_course("Python", 1, 4, 1)  
    insert_student("Sasank", "Ghimire", "023neb915@sxc.edu.np")
    insert_enrollments(1, 1, "A")

    update_teacher(1, name="Mrigendra P.", age=31)
    update_department(1, "Information Technology")
    update_course(1, course_name="Advanced Python", credits=5)
    update_student(1, first_name="Sasank", last_name="Ghimire", email="sasankghimire24@gmail.com")
